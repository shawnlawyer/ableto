...
Vue.component('survey', __webpack_require__(34));
...
window.axios.defaults.headers.common['X-CSRF-TOKEN'] = jQuery('meta[name="csrf-token"]').attr('content');
...
Component.options.__file = "/home/ubuntu/workspace/resources/assets/js/components/Survey.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-53802dd7", Component.options)
  } else {
    hotAPI.reload("data-v-53802dd7", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-53802dd7", module.exports)
  }
}
